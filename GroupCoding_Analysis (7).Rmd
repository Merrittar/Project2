...
```{r BMIcalculation}
# Ask about -> Converting pounds to kilos, inches to meters
NFL <- NFL %>%
...
ggplot(NFL, aes(Height))+
  ...
  labs(title="", x="Count of NFL Players", y="Height of NFL PLayers(in inches)") + 
  theme_minimal()
...
geom_bar(fill = "blue", color = "black") + scale_y_log10() + 
labs(title = "Play Time Distribution", subtitle = "How long do NFL players play?", x = "Hours per Day", y = "Players")
+ theme_light()
